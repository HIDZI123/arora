...
const translations = {
  en: {
    ...
    emergencyMessage:
      "This is an emergency! Please help, I'm in danger and need assistance.",
  ...
  hi: {
    ...
    emergencyMessage:
      "यह एक आपात स्थिति है! कृपया मदद करें, मैं खतरे में हूं और सहायता की आवश्यकता है।",
  ...
  mr: {
    ...
    emergencyMessage:
      "ही आणीबाणीची परिस्थिती आहे! कृपया मदत करा, मी धोक्यात आहे आणि मला मदतीची गरज आहे.",
  ...
  gu: {
    ...
    emergencyMessage:
      "આ એક કટોકટી છે! કૃપા કરીને મદદ કરો, હું ખતરામાં છું અને મદદની જરૂર છે.",
  ...
  ta: {
    ...
    emergencyMessage:
      "இது ஒரு அவசர நிலை! தயவுசெய்து உதவுங்கள், நான் ஆபத்தில் இருக்கிறேன் மற்றும் உதவி தேவை.",
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, padding: 16 }}>
        ...
        <View style={{ marginBottom: 16 }}>
          <Text style={{ marginBottom: 8 }}>
            {translations[language].languageSelector}
          </Text>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {languageOptions.map((option) => (
              <TouchableOpacity
                ...
                style={{
                  backgroundColor:
                    language === option.code ? "#007AFF" : "#E0E0E0",
                  padding: 8,
                  borderRadius: 4,
                  marginRight: 8,
                }}
              ...
              >
                <Text
                  style={{
                    color: language === option.code ? "white" : "black",
                  }}
                >
                  {option.name}
                </Text>
