    ...
    const getData = async () => {
      try {
        const response = await axios.get(
          "https://2xrn8gcc-3000.inc1.devtunnels.ms/api/webinars/get-webinars"
        );
  ...
  return (
    <ScrollView className="flex-1 p-4 bg-white">
      ...
      {webinars.map((webinar, index) => (
        <View
          key={index}
          className="bg-white rounded-lg shadow-lg p-4 mb-6 border border-gray-300 transition-transform duration-300 hover:scale-105"
        >
